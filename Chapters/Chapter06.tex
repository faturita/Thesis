...
\begin{figure}[htb]
\centering
\subfigure[Subject performing the experiment described in section \ref{P300healthysubject}.]{\includegraphics[width=.45\linewidth]{images/gTecsubject2.jpg}}
\caption[Subject wearing a g.Tec Device]{Subject wearing a g.Tec Device performing P300 Experiment.}
