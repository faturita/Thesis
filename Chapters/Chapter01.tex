...
On the other hand,  \textbf{Spectral Filters} consider brainwaves as another digital signal, and they perform different transformations based on the spectral information contained within the signal $\mathbf{x}(n)$.  They can be used in combination conforming  \textit{Filter Banks} that can be applied as a sort of tool to enhance signal quality. 
