...
BCIs are currently defined as: a system that measures central nervous system (CNS) activity and converts it into artificial output that replaces, restores, enhances, supplements, or improves natural CNS output and thereby changes the ongoing interactions between the CNS and its external internal environment (WOLPAW AND WOLPAW 2012)
...
Although during the last decade, BCI research had rampantly been advanced accomplishing a BCI Society, a BCI Journal, BCI Award, annual conference meetings, practical applications, myriads of startups companies and even included in the Gartner list of Hype technologies [7], yet its primary objective, its core motive of moving into real applications for disabled people has yet to come [6,9,2]. Among the many and current challenges of BCI [6] one which is still perennial is precisely their inability to be used and applied outside the BNCI community and specifically in clinical context. In order to help in reverting this tendency the physician must be kept in the loop.
...
GRAFICO QUE MUESTRA COMO SE EXPANDE LA ACCION DEL DIPOLO\\
...
\begin{chronology}[5]{1983}{2010}{30ex}[\textwidth]
\event{1984}{one}
\event[1985]{1986}{two}
