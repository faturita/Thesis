...
\subfigure[The digital signal is upsampled 4 times with a linear interpolation with splines. The Bresenham algorithm is used to compose the plot.]
...
\begin{figure}[htb]
\centering
\subfigure[Vertical axis is voltage in $\mu V$ while horizontal axis is expressed in sample points.]
