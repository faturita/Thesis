...
The image creation and signal plotting is a digitalization process as well~\cite{Schomer2010}.  Any digitalization process is defined by their Dynamic Range, Resolution and Precision.
...
This also determines the highest frequency that can be captured by the plotting scheme.  Half the number of pixels per seconds which is exactly equal to the Nyquist Frequency when the relation between pixels and time points is 1 to 1.

\begin{table}[htb]
\caption[Reference Values for Horizontal Precision and Resolution]{Reference Values for Precision and Resolution}
\centering
\vspace{8pt}
%% \tablesize{} %% You can specify the fontsize here, e.g.  \tablesize{\footnotesize}. If commented out \small will be used.
\begin{tabular}{|c|c|c|}
\toprule
\textbf{$\gamma$}	&  $1 P_x$ 	&  Decimal Precision   \\
\midrule
1     &     $1 \si\mu{V}$   &  $0$                                      \\
...
\begin{table}[htb]
\caption[Reference Values for Vertical Resolution]{Reference Values for Vertical Resolution}
\centering
\vspace{8pt}
%% \tablesize{} %% You can specify the fontsize here, e.g.  \tablesize{\footnotesize}. If commented out \small will be used.
\begin{tabular}{|c|c|}
...
The minimum recomended resolution for an EEG device is around 0.5 micorvolts.