...
Las interfaces BCI (Brain Computer Interfaces, Interfaces Cerebro Computadora) ó BMI (Brain Machine Interfaces, Interfaces Cerebro Máquina) surgen como un nuevo canal de comunicación entre el cerebro y las computadoras, máquinas o robots, distinto de los canales biológicos estándar.  Resultados prometedores han sido obtenidos por sus variantes invasivas, pero problemas persistentes de biocompatibilidad y, las complejidades y riesgos de los procedimientos quirúrgicos son las principales razones que impulsan las mejoras de las tecnologías no invasiva.
...
Esta tesis propone un método y un marco para analizar las formas de ondas, las formas de las señales de EEG, utilizando los histogramas de gradientes orientados, una útil técnica de Visión Artificial que es utilizada para tipificar características locales en regiones de una imagen.  Este procedimiento está inspirado en lo que tradicionalmente los técnicos electroencefalógrafos han realizado por casi un siglo: inspeccionar visualmente los registros electroencefalográficos.

La presente técnica puede resumirse en 5 pasos, (1) preprocesamiento de la señal cruda, (2) segmentación de la señal, (3) una gráfica blanco y negro de la señal canal por canal, (4) asignación de una localización dentro de la imagen para posicionar un parche de un determinado tamaño y escala dependiendo del fenómeno cognitivo en estudio, y (5) el procedimiento para calcular el histograma de los gradientes orientados de la intensidades de los pixeles usando diferencias finitas, y alrededor de cada punto distinguido.  Este mecanismo genera un vector de 128 dimensiones, que se utiliza para comparar los segmentos de señales entre sí, y que permite entonces analizar el fenómeno cognitivo subyacente.

La validez del método es verificada estudiando tres patrones cognitivos.  Primero, las ondas visuales occipitales alfa son analizadas.  Se diseñó un protocolo experimental y se obtuvo un dataset mediante la utilización de un dispositivo electroencefalográfico digital de uso comercial.  Adicionalmente, la posibilidad del método de capturar el comportamiento de ondas oscilatorias es demostrada sobre un dataset público.  Su empleo se hace extensivo para analizar los Ritmos Mu de Imaginaria Motora, otro tipo de onda oscilatoria.  Se reporta la efectividad del método para discriminar entre imaginaria motora derecha de izquierda en base al estudio de otro dataset público de pacientes sanos.  Los resultados son informados y reportados.  

Finalmente, esta propuesta es utilizada para estudiar eventos transitorios, particularmente el potencial evocado P300.  Se ofrece una descripción sobre cómo extraer este potencial de los segmentos de EEG, y se implementa un procesador de texto basado en P300 que utiliza este método.  La eficiencia del sistema es verificada mediante el procesamiento de un dataset público de pacientes con Esclerosis Lateral Amiotrófica, y corroborada contra un dataset de sujetos sanos obtenidos de manera experimental, replicando el mismo protocolo.

Los beneficios de esta propuesta se resumen en, (1) tiene una aplicación potencialmente universal, debido a que el mismo tipo de metodología puede ser aplicada para detectar cualquier tipo de patrón obtenido en la señal de EEG con eventuales aplicaciones a BCI, y (2) ofrece la posibilidad de incentivar la colaboración y utilización de estas técnicas en la clínica médica especializada en electroencefalografía ya que esta perspectiva basada en el estudio de las formas de onda de las señales, es un procedimiento conocido y ya establecido por esa comunidad.


%Las interfaces BCI (Brain Computer Interfaces, Interfaces Cerebro Computadora) ó BMI (Brain Machine Interfaces, Interfaces Cerebro Máquina) surgen como un nuevo canal de comunicación entre el cerebro y las computadoras, máquinas o robots, distinto de los canales biológicos estándar. Tienen un carácter fuertemente interdisciplinario, donde convergen ramas de neurobiología, psicología, matemática, ciencias de la computación e ingeniería.
%
%Las personas afectadas por enfermedades o traumas neurológicos tales como \textit{amiotrofía, esclerosis múltiple, ACV, lesiones espinales, parálisis cerebral} sufren un problema derivado que es la imposibilidad, parcial o total, de comunicarse, tanto así sea como por el atrofiamiento de los sentidos para la recepción de información, como por los inconvenientes motores que pueden presentarse para transmitir esa información.  Este es el grupo de usuario potenciales de esta herramientas, especialmente utilizando dispositivos no invasivos de adquisición de señales cerebrales como la Electroencefalografía.
%
%Con el objetivo de extraer la información oculta de estas señales, diversas técnicas computacionales y se han desarrollado con diferentes grados de éxito.  Hasta el momento, esta disciplina no ha considerado a las técnicas y el conocimiento producido para la clínica médica en psiquiatría o neurocirujía, el cual está basado en el estudio de las formas de ondas que las señales de electroencefalografía dejan sobre los registros encefalográficos.
%
%Este trabajo presenta un método basado en técnicas de Visión por Computadora para analizar y clasificar señales de Electroencefalografía, capturando la estructura de la forma de la onda de la señal.  Este método esta inspirado en cómo la corteza visual identifica patrones de orientaciones.
%El método procede en 4 pasos, (1) se produce una gráfica de la señal canal por canal, (2) se asigna una localización dentro de la imágen para posicionar un parche de un determinado tamaño y escala, (3) se divide al parche en una grilla de 4x4, (4) se obtiene un campo vectorial 
%
%
%
%This technique can be applied to identify components in EEG signals in five steps, (1) signal preprocessing, (2) signal segmentation, (3) transformation on a channel by channel basis of each signal segment into a binary image of a signal plot, (4) assignment of keypoint location on the newly created image depending on the physiological phenomena under study and finally (5) calculation of the histogram of gradient orientations using finite differences from the image around the keypoint (Figure 1). This method generates a feature, a normalized 128-dimension SIFT descriptor, which can be used to compare the signal segments that were used to generate the plots, thus they can be used to analyze the underlying cognitive phenomena. 
%
%
% con ello se construye un histograma de gradientes orientados e ironicamente se utiliza para identificar justamente algunos aspectos de cómo el cerebro procesa cierta información.
%
%La validez y alcance del método es evaluado mediante el estudio de Ondas Alfa, señales $\mu$ de imaginación motora y detectando potenciales evocados como el P300.  Adicionalmente, se aplica para implementar un procesador de texto basado en P300.

%El advenimiento de mejoras en los dispositivos de diagnóstico que capturan información de bioseñales generadas en el Sistema Nervioso Central abrió la puerta a la posibilidad de utilizar esas señales para transmitir información y controlar elementos tecnológicos directamente de manera intencional mediante la actividad mental.
%Estos mecanismos generan un nuevo canal de comunicación y tienen por ello una inmediata aplicación en la vida de personas afectadas principalmente por enfermedades neurodegenerativas, que conllevan generalmente a una reducción, o incluso eliminación, de la posibilidad de transmitir información por los canales habituales de habla o gestos.
%
% En este trabajo doctoral, se desarrolla un método para analizar las señales cerebrales de Electroencefalografía de forma automática basado en las diferentes formas de onda de la señal.  Este algoritmo permite identificarlas, clasificarlas, catalogarlas, y tiene una directa aplicación para controlar computadoras, drones, teléfonos celulares o cualquier otro elemento tecnológico.
...
%
%Este trabajo resurge las viejas dieas
